...
def extract_oracle(samples):
    for idx, data_entity in samples:
        ...
        # Obtain oracle index
        with open('/home/zixuandeng_alan/Dyle_chatgpt/QMSum/ALL/greedy/ref_{}/{}.ref'.format(mode, idx), 'w') as f:
            for sent in sent_tokenize(ref):
                print(sent, file=f)
    
        # Obtain gold summary reference
        with open('/home/zixuandeng_alan/Dyle_chatgpt/QMSum/ALL/greedy/dec_{}/{}.dec'.format(mode, idx), 'w') as f:
            for sent in sent_tokenize(oracle):
                print(sent, file=f)

        # Obtain decoded oracle
        with open('/home/zixuandeng_alan/Dyle_chatgpt/QMSum/ALL/greedy/index_{}/{}.dec'.format(mode, idx), 'w') as f:
...
eval_rouge('/home/zixuandeng_alan/Dyle_chatgpt/QMSum/ALL/greedy/dec_{}'.format(mode), 
            '/home/zixuandeng_alan/Dyle_chatgpt/QMSum/ALL/greedy/ref_{}'.format(mode))